...
extern "C"
{
    EXPORT void CC ForceThisDllToLoadInGta2Exe()
    {
        // Never called because:
        // The patched Gta2.exe loads this Dll and its WinMain calls this function but:
        // 1. The dll is statically loaded as the EXE has been patched.
        // 2. See that dll main hooks all reimplemented functions.
        // 3. WinMain is reimplemented so the real EXE's WinMain is now a jmp to our replacement
